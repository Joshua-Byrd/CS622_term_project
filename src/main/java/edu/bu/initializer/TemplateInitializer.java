...
public class TemplateInitializer {
    ...
    public void createAndSaveTemplates() {
        ...
        largeCaveRoomInventory.addItem(new Weapon("spear", "a long staff with a small diamond-shaped blade set on one end",
                5.0, 8, 15.0));
        Room largeCaveRoom = facadeModel.createRoom("large cave", "The entryway opens up into an enormous cavern, dimly " +
        ...
        Room hiddenGrotto = facadeModel.createRoom("carved grotto", "In this mysterious cave, carvings of grotesque faces " +
                "line the walls. It is illuminated by a glowing pool of water in the center of the cave.\nIt feels otherworldly here.\n" +
        ...
        Room crystalCavern = facadeModel.createRoom("cavern made of crystal", "Everywhere you look are " +
                "jagged crystals reflecting your own visage back at you.\n" +
        ...
        abandonedForgeInventory.addItem(new Weapon("smithing hammer", "A heavy hammer used for forging weapons and armor", 5.0, 6, 25.0));
        abandonedForgeInventory.addItem(new Armor("plate mail", "A slightly rusty set of plate mail", 8.0, 4, 30.0));

        Room abandonedForge = facadeModel.createRoom("deserted forge", "You see the corroded remains " +
