...
//            logFile.close();
//        } catch(IOException e) {
//            throw new LoggerException("LoggerException: Error reading from log file in GameLogger.printLog().", e);
//        }
//    }
//
//    /**
...
public class GameLogger {
    ...
    public static void setInstance(GameLogger loggerInstance) {
